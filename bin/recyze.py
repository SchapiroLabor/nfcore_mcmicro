...
class PyramidWriter:
    ...
    def write_channel_image(self, channel_data, output_path):
        with tifffile.TiffWriter(output_path, ome=False, bigtiff=True) as tiff:
            tiff.write(
                data=channel_data,
...
if __name__ == '__main__':
    ...
    print(f"All channels: {args.channels}")
